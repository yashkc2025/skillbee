  ...
  <ParentAppLayout>
    ...
    <section class="child-info">
      <div class="first">
        ...
        <button class="button-admin" @click="removeChildren">Remove Children</button>
      </div>
      <div class="second">
    ...
    <section class="feedback-form box-shadow" v-show="showForm">
      ...
      <CardV2 label-image="bi bi-input-cursor-text" label-title="Feedback Form">
        ...
        <template #content>
          <InputComponent icon="bi bi-cursor-text" name="feedback" placeholder="Write something!" input-type="TextArea"
            :required="true" v-model="feedbackText" />
