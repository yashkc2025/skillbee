      ...
      <div class="forms-container">
        <div class="signin-signup">
          ...
          <div class="sign-in-form">
            <h2 class="title ft-head-1">
              {{ selectedUserType ? "Selected" : "Select" }} a user to login
            ...
            <div class="user-btn-box" v-if="!selectedUserType">
              <button
                v-for="userType in signInUserTypes"
                :key="userType"
                class="btn user-btn"
            ...
            <div v-if="selectedUserType && showAlternativeTypes" class="alternative-btn">
              ...
              <div class="alternative-btns">
                <button
                  v-for="userType in alternativeUserTypes"
                  :key="userType"
          ...
          <div class="sign-up-form">
            <h2 class="title ft-head-1">
              ...
              <span
                >as
                {{
                  selectedUserType === "Child" ? "Independent Child" : selectedUserType
                }}
              </span>
            </h2>
            ...
            <div class="user-btn-box" v-if="!selectedUserType">
              <button
                v-for="userType in signUpUserTypes"
                :key="userType"
                class="btn user-btn"
                @click="handleUserTypeSelection(userType)"
              >
            ...
            <form v-if="selectedUserType" @submit.prevent="handleRegister">
              <div
                v-for="field in registerFormFields"
                :key="field.name"
                class="form-field"
              >
                <i :class="getIconClass(field.icon)"></i>
